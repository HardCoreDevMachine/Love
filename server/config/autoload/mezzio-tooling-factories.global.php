...
return [
    'dependencies' => [
        'factories' => [
            App\Handler\GameCacheHandler::class => App\Handler\GameCacheHandlerFactory::class,
            App\Handler\GameFormHandler::class => App\Handler\GameFormHandlerFactory::class,
        ],
    ],
];
